...
# TODO: remove lines when underway system was not on (before 9/2/2023  1:50:00 AM, after 9/04 09:01 row 165841)
# TODO: Add columns we left out that SOCAT wants: Pressure_ATM, Pressure_EQU, xCO2_EQU, xCO2_ATM, xCO2_ATM_interpolated (confirm timestamps)
# TODO: edit column headers to match SOCAT formats
...
write.table(underway, here('output','LOC-01_underway.txt'), col.names = FALSE, row.names=FALSE, append=TRUE)
